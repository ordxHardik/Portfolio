          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/ordxHardik/BingeWatch" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" /></a>
                <a href="https://binge-watch-flax.vercel.app/" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
                </a> </div>
            </header>
            <div className="body">
              <h3>Binge Watch - Movie Search App</h3>
            ...
            <footer> <ul className="tech-list"> <li>React</li> <li>JavaScript</li> <li>React Bootstrap</li> </ul> </footer>
          </div>
        </ScrollAnimation>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              <svg width="50" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="#23ce6b " strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"><title>Folder</title> <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path> </svg>
              <div className="project-links">
                <a href="https://github.com/ordxHardik/RapiDoc" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" /> </a>
                <a href="https://ordxhardik.github.io/RapiDoc/" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" /></a>
              </div>
            </header>
            <div className="body">
              <h3>Rapidoc-Your One-stop digital healthcare destination.</h3>
              <p>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/ordxHardik/Text_To_Speech" target="\_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" />
                </a>
                <a href="https://ordxhardik.github.io/Text_To_Speech/" target="\_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
                </a>
              </div>
            </header>
            <div className="body">
              <h3>Text to Speech Recognition Project</h3>
              <p>
              Build a simple text-to-speech generator using HTML for the interface, CSS for styling, and JavaScript to integrate a text-to-speech API, allowing users to input text and hear it spoken aloud.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/Chirag26mahajan/Himalayas-Calling" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" />
                </a>
                <a href="https://chirag26mahajan.github.io/Himalayas-Calling/" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
                </a>
              </div>
            </header>
            <div className="body">
              <h3>Himalayas-Calling</h3>
              <p>Himalayas Calling" is a rental website offering a wide selection of cars and bikes for rent, catering specifically to adventurers exploring the Himalayan region.
              Himalayas Calling" is a dedicated rental platform designed for adventurers, explorers, and nature enthusiasts seeking to discover the breathtaking beauty of the Himalayan region. The website offers a wide range of vehicles, including rugged 4x4 cars, motorcycles, and bikes, all suited for navigating the challenging terrains and winding roads of the Himalayas
              </p>
            </div>
            <footer>
              <ul className="tech-list">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/shubham4672/PIG-Game" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" />
                </a>
                <a href="https://shubham4672.github.io/PIG-Game/" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
                </a>
              </div>
            </header>
            <div className="body">
              <h3>Pig Game</h3>
              <p>This is a two-player game built using HTML, CSS, and JavaScript. In this game, players can compete with each other based on their luck and strategy to beat the other player by scoring 100 points before their opponent does. The game logic is implemented entirely in JavaScript.</p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>HTML</li>
